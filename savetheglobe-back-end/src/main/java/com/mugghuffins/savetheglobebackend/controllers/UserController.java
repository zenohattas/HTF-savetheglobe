...
import com.mugghuffins.savetheglobebackend.exceptions.UserNotFoundException;
...
public class UserController {
    @Autowired
    private com.mugghuffins.savetheglobebackend.repository.UserRepository userRepository;
